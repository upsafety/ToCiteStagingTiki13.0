{* $Id: profiles_featured_site_confs.tpl 51568 2014-06-02 09:41:09Z chibaguy $ *}
        ...
        <fieldset>
	        ...
	        <div class="row">
	            ...
	            <div class="col-md-6">
	                ...
	                <br>
                    <p>{tr}Setup for a Corporate Intranet of a typical medium-sized business{/tr}.
	        ...
	        <div class="row">
	            <div class="col-md-6">
	                ...
	                <br>
                    <p>{tr}Setup with many cool features to help you integrate the Social Web and establish a strong presence in the Blogosphere{/tr}
	            ...
	            <div class="col-md-6">
    	            ...
    	            <br>
                    <p>{tr}Setup for a Web Presence of a typical small business or non-profit{/tr}.
