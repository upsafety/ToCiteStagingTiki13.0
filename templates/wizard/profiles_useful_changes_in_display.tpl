{* $Id: profiles_useful_changes_in_display.tpl 51968 2014-07-16 11:10:30Z xavidp $ *}
        ...
        <fieldset>
	        ...
	        <div class="row">
                <div class="col-md-6">
                    ...
                    <br/><a href="https://doc.tiki.org/Slideshow"  target="tikihelp" class="tikihelp" title="{tr}Slideshow demo{/tr}:
        	        {tr}More details{/tr}:
                    <ul>
