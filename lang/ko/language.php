...
"Enable 3D tags browser" => "프리태그 3D 브라우저 활성화",
"3D autoload" => "3D 자동로드",
...
"If the tags feature is enabled, use the tags in the meta keywords for each page with tags set. This allows individual pages at the site to have different meta tags" => "프리태그 기능이 활성화된 경우, 프리태그 세트가 있는 각 페이지에 대한 메타 키워드 안에서 프리태그를 사용합니다. 이는 사이트 상의 개별 페이지가 다른 메타 태그를 지닐 수 있게 합니다",
...
"Field ID of Tags for Archive (tags field type)" => "보관의 태그의 필드 ID (프리태그 필드 유형)",
"The Archive tracker could have a tags field for storing the tags of the recording" => "보관 트래커는 녹음의 태그를 지정하기 위한 프리태그 필드를 보유할 수 있ㅅ브니다",
...
"On" => "켜기",
"Add Tag" => "태그 추가",
"Add a single tag to specified object" => "지정된 개체에 하나의 프리태그 추가",
"Object" => "개체",
